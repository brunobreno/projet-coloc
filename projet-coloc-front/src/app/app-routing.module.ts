...
const routes: Routes = [
  ...
  { path: "rechercheLogement/undefined", component: RechercheLogementComponent },
  { path: "rechercheLogement/:ville", component: RechercheLogementComponent },
  ...
  { path: "descriptionLogement/:id", component: DescriptionLogementComponent},
